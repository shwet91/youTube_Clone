...
const VideoCard = ({ 
  ...
  return (
    <div className="w-1/5 h-1/4  bg-slate-800 rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300"  onClick={() => console.log("clicked")}  >
